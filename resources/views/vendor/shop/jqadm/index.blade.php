...
<html lang="en">
	...
	<body>
		<div class="app-menu" style="background: #202830; text-align: right; cursor: pointer;">
                    <i title="Logout" class="logout fa fa-sign-out" style="color: #fff; padding: 0.5em 1.5em" aria-hidden="true" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"></i>
